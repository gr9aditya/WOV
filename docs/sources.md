...
Photographs of the deck are **not included in this repository** — the material is Swiss Post's,
not ours. See [Reference material and licensing](#reference-material-and-licensing).
...
**Original.** All prose, the pixel art, and every line of code. The character, coin, furniture and
palette are our own, loosely following Swiss Post's use of yellow as the highlight colour.
...
The printed Swiss Post briefing deck is reference material owned by Swiss Post. Photographs of it
are deliberately kept out of this repository; only the facts drawn from it are reproduced here, in
our own words. Do not add the images unless you have permission to redistribute them.
