...
///
///     Unity.exe -batchmode -quit -projectPath . -executeMethod PixelWalkthroughBuild.PerformBuild -buildOutput <folder>
///
...
public static class PixelWalkthroughBuild
{
    const string ProductName = "EVotingPixelWalkthrough";
    const string ScenePath = "Assets/EVotingWalkthroughPixel/PixelWalkthrough.unity";

    [MenuItem("E-Voting Walkthrough Pixel/Create and Open Scene")]
    public static void CreateScene()
    {
        ...
        new GameObject("Walkthrough").AddComponent<PixelWalkthrough>();
    ...
    [MenuItem("E-Voting Walkthrough Pixel/Build Windows Player")]
